return {
    ...
    pauseMapText = 'Pause menu', -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear
    ...
    characters = {
        ...
        dateMax = '2026-09-05', -- Has to be in the same format as the dateFormat config
