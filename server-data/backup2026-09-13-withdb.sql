...
-- Dumping database structure for fivem-server-project
CREATE DATABASE IF NOT EXISTS `fivem-server-project` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `fivem-server-project`;
...
-- Dumping data for table fivem-server-project.phone_migrations: ~4 rows (approximately)
...
-- Dumping data for table fivem-server-project.renzu_motels: ~1 rows (approximately)
